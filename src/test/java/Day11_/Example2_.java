...
public class Example2_ {
   ...
   @BeforeSuite
   public void preconditions() throws InterruptedException, IOException, BiffException {
   ...
   @Test
   public void testScenario() throws WriteException, InterruptedException, WriteException {
